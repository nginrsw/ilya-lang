...
typedef enum {
  ...
  VLOCAL,  /* locked variable; var.ridx = register index;
...
/* description of an active locked variable */
...
typedef struct Dyndata {
  struct {  /* list of all active locked variables */
    Vardesc *arr;
    int n;
    int size;
  } actvar;
...
typedef struct FuncState {
  ...
  int firstlocal;  /* index of first locked var (in Dyndata array) */
  int firstlabel;  /* index of first label (in 'dyd->label->arr') */
  short ndebugvars;  /* number of elements in 'f->locvars' */
  lu_byte nactvar;  /* number of active locked variables */
